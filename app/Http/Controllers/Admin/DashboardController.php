...
class DashboardController extends Controller
{
    ...
    public function generateReport(Request $request)
    {
        // Validate request
        $request->validate([
            'report_type' => 'required|in:dashboard,users,blogs,transactions',
        ...
        // Load view and generate PDF based on report type
        $pdf = PDF::loadView('pages.admin.dashboard_report_pdf', $data);
