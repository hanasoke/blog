...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <div>
            ...
            <button type="button" class="btn btn-sm btn-danger shadow-sm" data-toggle="modal" data-target="#reportModal">
                <i class="fas fa-download fa-sm text-white-50"></i> 
                Generate Report
            </button>
            
            <!-- Export CSV Button -->
            <a href="{{ route('export_rejected_csv') }}" class="btn btn-sm btn-success shadow-sm ml-2">
        ...
        <div class="modal-content">
            <div class="modal-header bg-danger text-white">
                <h5 class="modal-title" id="reportModalLabel">
                    <i class="fas fa-download"></i> Generate Rejected Transactions Report
                </h5>
                <button type="button" class="close text-white" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form action="{{ route('generate_rejected_report') }}" method="GET" target="_blank">
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <select class="form-control" name="report_type" id="report_type" required>
                            <option value="all">All Rejected Transactions</option>
                    ...
                    <div class="form-group" id="date_range_fields" style="display: none;">
                        ...
                        <small class="text-muted">Filter by rejection date</small>
                    </div>
                    ...
                    <div class="alert alert-info mt-3">
                        ...
                        <strong>Info:</strong> The report will include all rejected transactions with rejection reasons and statistics.
                    </div>
                </div>
