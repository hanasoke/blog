...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Success Transaction</h1>
        <div>
            ...
            <!-- Export CSV Button -->
            <a href="{{ route('export_success_csv') }}" class="btn btn-sm btn-success shadow-sm ml-2">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h4 class="font-weight-bold text-primary m-0 float-left">Success Transaction</h4>
        </div>
        <div class="card-body">
            <!-- Alert Success -->
            @if(session('success'))
        ...
        <div class="modal-content">
            <div class="modal-header bg-primary text-white">
                <h5 class="modal-title" id="reportModalLabel">
                    <i class="fas fa-download"></i> Generate Success Transactions Report
                </h5>
                <button type="button" class="close text-white" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form action="{{ route('generate_success_report') }}" method="GET" target="_blank">
                <div class="modal-body">
                    ...
                    <div class="form-group" id="date_range_fields" style="display: none;">
                        ...
                        <small class="text-muted">Filter transactions by approval date</small>
                    </div>
                    ...
                    <div class="alert alert-info mt-3">
                        ...
                        <strong>Info:</strong> The report will include all approved transactions with revenue statistics.
                    </div>
                </div>
