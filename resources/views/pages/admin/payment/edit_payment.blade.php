...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a href="{{ route('payment') }}" class="d-none d-sm-inline-block btn btn-sm btn-secondary shadow-sm">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="font-weight-bold text-primary m-0 float-left">Edit Payment</h6>
        </div>
        <div class="card-body">
