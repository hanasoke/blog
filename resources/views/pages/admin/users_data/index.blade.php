...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <div class="btn-group" role="group" aria-label="Basic example">
            ...
            <!-- Export CSV Button -->
            <a href="{{ route('export_users_csv') }}" class="btn btn-sm btn-success shadow-sm">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="reportModalLabel">
                    <i class="fas fa-download text-primary"></i> Generate Users Report
                </h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form action="{{ route('generate_users_report') }}" method="GET" target="_blank">
                <div class="modal-body">
                    <div class="form-group">
                    ...
                    <div class="form-group" id="date_range_fields" style="display: none;">
                        ...
                        <small class="text-muted">Filter users by registration date</small>
                    </div>
                    ...
                    <div class="alert alert-info mt-3">
                        ...
                        <strong>Info:</strong> The report will include user profiles, access levels, and blog contributions.
                    </div>
                </div>
                <div class="modal-footer">
